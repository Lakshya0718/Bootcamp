...
import com.examples.gallerio.authenticationandprofilefunction.UserModel
...
//    val imageReference = db.collection("Users").document("Timeline").collection(currentUser)
    ...
    private fun addCategoryToFirestore(categoryId: String, categoryName: String, categoryImagePath: String) {
        ...
        var addCategoryModel = CategoryModel(
            categoryName,
            categoryImagePath
        )
    ...
    private fun addUserToDatabase(name: String, email: String, currentUid: String) {
        ...
        user = UserModel(
            name,
            email,
            "https://console.firebase.google.com/project/gallerio-e24d1/storage/gallerio-e24d1.appspot.com/files~2FprofileImage"
        )
